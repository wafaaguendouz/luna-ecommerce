...
export const login = (email, password, shop) => async (dispatch) => {
  try {
    dispatch({
    ...
    const { data } = await axios.post("/users/login", { email, password, shop },config);
    dispatch({
...
export const register = (name, email, password, shop) => async (dispatch) => {
  try {
    dispatch({
